    ...
    var StoryOverviewController = (function () {
        function StoryOverviewController($routeParams, $modal, StoryOverviewDataService, LinkDataService, ActorDataService) {
            ...
            this.onActorSaved = function (id) {
                _this.linkDataService.add(new Home.CreateLinkRequest(new Home.Node(_this.Overview.Summary.Id, Home.NodeTypeEnum.Story), new Home.Node(id, Home.NodeTypeEnum.Actor)))
                    .then(_this.onLinkSaved);
            };
