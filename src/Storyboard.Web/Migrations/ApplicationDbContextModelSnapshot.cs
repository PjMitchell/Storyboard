...
namespace Storyboard.Web.Migrations
{
    ...
    //        builder.Entity("Storyboard.Web.Models.ApplicationUser", b =>
    //            {
    ...
    //        builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityRoleClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]", b =>
    //            {
    //                b.Reference("Microsoft.AspNet.Identity.EntityFramework.IdentityRole").InverseReference().ForeignKey("RoleId");
    //            });

    //        builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]", b =>
    //            {
    //                b.Reference("Storyboard.Web.Models.ApplicationUser").InverseReference().ForeignKey("UserId");
    //            });
    ...
    //            {
    //                b.Reference("Microsoft.AspNet.Identity.EntityFramework.IdentityRole").InverseReference().ForeignKey("RoleId");
    //                b.Reference("Storyboard.Web.Models.ApplicationUser").InverseReference().ForeignKey( .ForeignKey("UserId");
    //            });
    //    }
    //}
}
